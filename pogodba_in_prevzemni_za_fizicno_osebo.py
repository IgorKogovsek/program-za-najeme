...
def kreiraj_pogodbo_in_zapisnik_FO():

    # najemna pogodba

    global master

    print(e1.get(), e2.get(), e3.get(), e4.get(), e5.get(), e7.get(), dokument.get(), e9.get(), e10.get(), e11.get(),
          e12.get(), e13.get(), e14.get(), e15.get(), e16.get(), e17.get(), fakturiranje.get(), lokacija.get(), skrbnik.get())

    input_ime_osebe = e1.get()

    input_priimek_osebe = e2.get()

    input_ulica = e3.get()

    input_hisna_stevilka = e4.get()

    input_postna_stevilka = e5.get()

    input_mesto = e6.get()

    input_drzava = e7.get()

    input_dokument = dokument.get()

    input_stevilka_dokumenta = e9.get()

    input_znamka = e10.get()
    ...
    input_reg_do = e14.get()

    input_najem_od = e15.get()

    input_najem_do = e16.get()

    input_obrok_brez_DDV = e17.get()
    ...
    najemojemalec.add_run(
        input_ime_osebe + " " + input_priimek_osebe + ", " + input_ulica + " " + input_hisna_stevilka + ", " + input_postna_stevilka + " " + input_mesto + ", " + input_drzava + ", dokument: " + input_dokument + ", številka dokumenta: " + input_stevilka_dokumenta + ", " + "(v nadaljevanju: najemojemalec) \n")
    ...
    zastopnik_ime_cells[3].text = input_ime_osebe + " " + input_priimek_osebe

    zastopnik_cells = table.rows[5].cells
    zastopnik_cells[0].text = "direktor"

    pogodba_name = "_".join(["najemna_pogodba", input_model, input_vin, input_ime_osebe, input_priimek_osebe, suffix])
    ...
    predajalec_prevzemalec_in_lokacija.add_run(
        "VOZILO PREJEL: " + input_ime_osebe + " " + input_priimek_osebe + ", " + input_ulica + " " + input_hisna_stevilka + ", " + input_postna_stevilka + " " + input_mesto + ", " + input_drzava + "\n"
    )
    predajalec_prevzemalec_in_lokacija.add_run(
    ...
    predajalec_prevzemalec_in_lokacija= doc1.add_paragraph()
    predajalec_prevzemalec_in_lokacija.add_run(
        "VOZILO VRNIL: " + input_ime_osebe + " " + input_priimek_osebe + ", " + input_ulica + " " + input_hisna_stevilka + ", " + input_postna_stevilka + " " + input_mesto + ", " + input_drzava + "\n"
    )
    predajalec_prevzemalec_in_lokacija.add_run(
    ...
    prevzemni_name = "_".join(["prevzemni_zapisnik", input_model, input_vin, input_ime_osebe, input_priimek_osebe, suffix])

    #preveri ali so vsi podatki izpolnjeni
    if e1.get() and e2.get() and e3.get() and e4.get() and e5.get() and e7.get() and dokument.get()!="Izberi" and e9.get() and e10.get() and e11.get() and e12.get() and e13.get() and e14.get() and e15.get() and e16.get() and e17.get() and fakturiranje.get()!="Izberi" and lokacija.get()!="Izberi" and skrbnik.get()!="Izberi":
        master3 = Tk()
...
master = tk.Tk()
master.title("SELMARapp - Najemna pogodba za fizično osebo")
tk.Label(master, text="Ime osebe: ").grid(row=0)
tk.Label(master, text="Priimek osebe: ").grid(row=1)
tk.Label(master, text="Ulica: ").grid(row=2)
tk.Label(master, text="Hišna številka: ").grid(row=3)
tk.Label(master, text="Poštna številka: ").grid(row=4)
tk.Label(master, text="Mesto: ").grid(row=5)
tk.Label(master, text="Država: ").grid(row=6)
tk.Label(master, text="Dokument (potni list/osebna izkaznica): ").grid(row=7)
tk.Label(master, text="Številka dokumenta: ").grid(row=8)
tk.Label(master, text="Znamka: ").grid(row=9)
tk.Label(master, text="Model: ").grid(row=10)
tk.Label(master, text="VIN: ").grid(row=11)
tk.Label(master, text="Registrska oznaka (npr. CE AA-123): ").grid(row=12)
tk.Label(master, text="Registriran do: ").grid(row=13)
tk.Label(master, text="Najem od vključno: ").grid(row=14)
tk.Label(master, text="Najem do vključno: ").grid(row=15)
tk.Label(master, text="Obrok brez DDV: ").grid(row=16)
tk.Label(master, text="Cena na dan ali mesec: ").grid(row=17)
tk.Label(master, text="Kraj izdaje: ").grid(row=18)
tk.Label(master, text="Skrbnik: ").grid(row=19)
...
e6 = tk.Entry(master)
e7 = tk.Entry(master)
e8 = OptionMenu(master, dokument, *DOCUMENTS)
e9 = tk.Entry(master)
e10 = tk.Entry(master)
e11 = tk.Entry(master)
e12 = tk.Entry(master)
...
e16 = tk.Entry(master)
e17 = tk.Entry(master)
e18 = OptionMenu(master, fakturiranje, *FACTURING)
e19 = OptionMenu(master, lokacija, *OPTIONS)
e20 = OptionMenu(master, skrbnik, *PERSONS)
...
button2 = tk.Button(master,
          text='Kreiraj pogodbo in prevzemni zapisnik', command=kreiraj_pogodbo_in_zapisnik_FO).grid(row=21,
                                                                column=1,
                                                                sticky=tk.W,
                                                                pady=4)
